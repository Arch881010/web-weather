document.addEventListener('DOMContentLoaded', () => {
    ...
    const saveSettings = () => {
        ...
        const opacityPolygonFill = document.getElementById('opacity-polygon-fill').value / 100;
        const opacityPolygon = document.getElementById('opacity-polygon').value / 100;
        const opacityCountyBorders = document.getElementById('opacity-county-borders').value / 100;
    ...
    const loadSettings = () => {
        ...
        if (savedSettings) {
            document.getElementById('save-settings').checked = savedSettings.saveSettings;
            document.getElementById('opacity-radar').value = savedSettings.opacity.radar * 100;
            document.getElementById('opacity-polygon-fill').value = savedSettings.opacity.polygon_fill * 100;
            document.getElementById('opacity-polygon').value = savedSettings.opacity.polygon * 100;
            document.getElementById('opacity-county-borders').value = savedSettings.opacity.countyBorders * 100;
